...
model = load_model(r'C:\Users\PC\Desktop\Project\api\predictor\models\chatbot_model.h5')
intents = json.loads(open(r'C:\Users\PC\Desktop\Project\api\predictor\models\IntentsDocument.json').read())
words = pickle.load(open(r'C:\Users\PC\Desktop\Project\api\predictor\models\words.pkl','rb'))
classes = pickle.load(open(r'C:\Users\PC\Desktop\Project\api\predictor\models\classes.pkl','rb'))
#Execute once
...
pred_model = joblib.load(r'C:\Users\PC\Desktop\Project\api\predictor\models\disease_esitmator.sav')
...
le.classes_ = np.load(r'C:\Users\PC\Desktop\Project\api\predictor\models\Lab_encoder.npy', allow_pickle=True)
